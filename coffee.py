...
menu = [
    {'ID': 1, 'name': 'Flat White', 'price': 5, 'popular': True, 'type': 'coffee'},
    {'ID': 2, 'name': 'Cappuccino', 'price': 5, 'popular': True, 'type': 'coffee'},
    {'ID': 3, 'name': 'Cafe Latte', 'price': 5.5, 'popular': True, 'type': 'coffee'},
    {'ID': 4, 'name': 'Vanilla Latte', 'price': 6.5, 'popular': True, 'type': 'coffee'},
    {'ID': 5, 'name': 'Caramel Latte', 'price':6.5, 'popular': True, 'type': 'coffee'},
    ...
    {'ID': 12, 'name': 'Mocha', 'price': 6, 'popular': False, 'type': 'chocolate'},
    ...
    {'ID': 15, 'name': 'White Chocolate Mocha', 'price': 6.8, 'popular': False, 'type': 'chocolate'},
    {'ID': 16, 'name': 'English Breakfast', 'price': 4.5, 'popular': False, 'type': 'tea'},
    {'ID': 17, 'name': 'Green Tea', 'price': 4.5, 'popular': False, 'type': 'tea'},
    ...
    {'ID': 23, 'name': 'Ice Latte', 'price': 7, 'popular': False, 'type': 'cold'}
]
